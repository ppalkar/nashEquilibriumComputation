...
subject to alpha1_constraint1{s in S, a1 in A1[s]}:
    K1*alpha1[s,a1] >= (v1[s] - (sum{a2 in A2[s]} R1[s,a1, a2]*g[s,a2]) 
    - beta*(sum{a2 in A2[s]} T1[s, a1,a2]*g[s,a2])) ;

subject to alpha2_constraint1{s in S, a2 in A2[s]}:
    K2*alpha2[s,a2] >= (v2[s] - (sum{a1 in A1[s]} R2[s,a1, a2]*f[s,a1]) 
    - beta*(sum{a1 in A1[s]} T2[s, a1,a2]*f[s,a1])) ;
...
minimize obj:
    (sum{s in S , a1 in A1[s]} (alpha1[s,a1] + gamma1[s,a1])) + 
    (sum{s in S, a2 in A2[s]} (alpha2[s,a2] +gamma2[s,a2]));
